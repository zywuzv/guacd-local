...
RUN apk add --upgrade --allow-untrusted /tmp/linux-pam-1.5.3-r7.apk

RUN rm /tmp/linux-pam-1.5.3-r7.apk

# COPY packages/openjpeg-2.5.3-r0.apk /tmp/
#
# RUN apk add --upgrade --allow-untrusted /tmp/openjpeg-2.5.3-r0.apk
#
# RUN rm /tmp/openjpeg-2.5.3-r0.apk
